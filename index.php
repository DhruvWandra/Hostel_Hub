        ...
        echo '<div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-5 animated fadeIn mb-4">Explore a World of Comfort with <span class="text-primary">HostelHub</span> - Your Premier Hostel Finding Platform</h1>
                    <p class="animated fadeIn mb-4 pb-2">Vero elitr justo clita lorem. Ipsum dolor at sed stet
                        sit diam no. Kasd rebum ipsum et diam justo clita et kasd rebum sea elitr.</p>';
        if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
            echo '
                                <p class="text-info my-0 mx-2 fw-bolder fs-3">Welcome "' . $_SESSION['useremail'] . '" </p>
                                <a href="./partials/_logout.php" class="btn btn-primary py-3 px-5 me-3 animated fadeIn">Logout</a>';
        } else {
            echo '<a href="userlogin.php" class="btn btn-primary py-3 px-5 me-3 animated fadeIn">Get Started</a>';
        }
        echo '</div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-4">#1 Place To Find The Perfect Pg&Hostel</h1>
                    ...
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            ...
                            <!-- <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href="details.php"><img class="img-fluid" src="img/property-1.jpg" alt=""></a>
                                        <div class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">4 Star</div>
                                        <div class="bg-white rounded-top text-primary position-absolute start-0 bottom-0 mx-4 pt-1 px-3">House</div>
                                    </div>
                                    <div class="p-4 pb-0">
